...
<div region="north" style="height: 58px;background-color: #ffff">
    <table width="100%">
        <tr>
            <td width="50%" style="font-size: 20px;color:#8B8B8B;font-family: '楷体';"><font size="4">电视直播管理系统</font></td>
            <td valign="bottom"
    ...
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 100px">
                <font color="grey" size="10">IPTV SYSTEM</font>
            </div>
        </div>
    </div>
</div>
<div region="west" style="width: 200px;height:500px;" title="导航菜单"
    ...
    <div class="easyui-accordion">
        ...
        <div title="频道管理" data-options="iconCls:'icon-channel'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 频道管理','channelManage.jsp','icon-add')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-add'"
                    style="width: 150px;">频道管理</a>
            <%--<a--%>
                    <%--href="javascript:openTab(' 批量录入','channelManage.jsp','icon-add')"--%>
                    <%--class="easyui-linkbutton"--%>
                    <%--data-options="plain:true,iconCls:'icon-shuben'"--%>
                    <%--style="width: 150px;">批量录入</a>--%>
        </div>

        <div title="分类管理" data-options="iconCls:'icon-shujias'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 节目分类','channelClass.jsp','icon-edit')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-edit'"
                    style="width: 150px;"> 节目分类</a>
        </div>

        <div title="设备管理" data-options="iconCls:'icon-jcsjgl'"
             style="padding:10px;border:none;">
            <a href="javascript:openTab(' 服务器管理','serverManage.jsp','icon-lxr')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-lxr'" style="width: 150px;">
                服务器管理
            </a>
            <%--<a href="javascript:openTab(' 服务重启','serverManage.jsp','icon-lxr')"--%>
               <%--class="easyui-linkbutton"--%>
               <%--data-options="plain:true,iconCls:'icon-lxr'" style="width: 150px;">--%>
                <%--服务重启--%>
            <%--</a>--%>
        ...
        <div title="系统管理" data-options="iconCls:'icon-item'"
            ...
            <a href="javascript:openTab(' 用户管理','userManage.jsp','icon-lxr')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-lxr'" style="width: 150px;">
                用户管理</a> <a href="javascript:openPasswordModifyDialog()"
                            class="easyui-linkbutton"
