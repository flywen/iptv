...
<table id="dg" title="分类管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="tr/ue" data-options="pageSize:20"
    ...
    <tr>
        ...
        <th field="number" width="200" align="center">分类编号</th>
        <th field="level" width="200" align="center" formatter="Level">层数xx</th>
        <th field="page" width="200" align="center">总xx</th>
        <th field="status" width="200" align="center" formatter="Status">状态</th>
...
<div id="tb">
    <div>
        ...
        <a href="javascript:openStore()"
           class="easyui-linkbutton" iconCls="icon-kaiqi" plain="true">开启xx</a>
        <a href="javascript:closeStore()"
           class="easyui-linkbutton" iconCls="icon-guanbi" plain="true">关闭xx</a>
        <!-- <a
